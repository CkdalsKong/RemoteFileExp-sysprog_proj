...
void showctrl(){
	...
	mvprintw(i++,ctrlCol, "Delete");
	mvprintw(i++,ctrlCol, ": \'d\'");
	mvprintw(i++,ctrlCol, "Create Dir");
	mvprintw(i++,ctrlCol, ": \'m\'");
	mvprintw(i++,ctrlCol, "Search File");
	mvprintw(i++,ctrlCol, ": \'f\'");
	mvprintw(i++,ctrlCol, "Rename");
	mvprintw(i++,ctrlCol, ": \'r\'");
	mvprintw(i++,ctrlCol, "");
	mvprintw(i++,ctrlCol, "Sort(A to Z)");
	mvprintw(i++,ctrlCol, ": \'s\'");
	mvprintw(i++,ctrlCol, "Sort(A to Z)");
	mvprintw(i++,ctrlCol, ": \'S\'");
